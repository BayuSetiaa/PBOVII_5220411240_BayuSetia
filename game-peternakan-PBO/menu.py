...
from classes.constants import WIDTH, HEIGHT, BLACK, GREEN, YELLOW, BROWN
...
while show_menu:
    ...
    pygame.draw.rect(screen, BROWN, play_button_rect, border_radius=10)
    if selected_button == 0:
        pygame.draw.rect(screen, YELLOW, play_button_rect, border_radius=10, width=4)
    text_rect = text.get_rect()
    text_rect.center = play_button_rect.center
    screen.blit(text, text_rect)
    text = font.render("Exit", True, GREEN)
    pygame.draw.rect(screen, BROWN, quit_button_rect, border_radius=10)
    if selected_button == 1:
        pygame.draw.rect(screen, YELLOW, quit_button_rect, border_radius=10, width=4)
    text_rect = text.get_rect()
