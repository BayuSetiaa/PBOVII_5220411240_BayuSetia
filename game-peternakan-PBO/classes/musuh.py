...
class Musuh1(pygame.sprite.Sprite):
...
class Musuh2(pygame.sprite.Sprite):
    ...
    def update(self, enemy_group, enemy_bullets_group, player):
        if self.shots_fired < 10:
            ...
            if self.shoot_timer >= 60:
                bullet = Musuh2Bullet(self.rect.centerx, self.rect.bottom)
...
class Musuh2Bullet(pygame.sprite.Sprite):

    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load('images/peluru/peluru4.png').convert_alpha()
