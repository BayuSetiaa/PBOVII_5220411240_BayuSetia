...
class Dino1(pygame.sprite.Sprite):
    ...
    def update(self, enemy_bullets_group, player):
        ...
        if self.shots_fired < 20:
            ...
            if self.shoot_timer >= 60:
                bullet1 = Dino1Bullet(self.rect.centerx - 20, self.rect.bottom)
                bullet2 = Dino1Bullet(self.rect.centerx + 20, self.rect.bottom)
                bullet3 = Dino1Bullet(self.rect.centerx, self.rect.bottom)
...
class Dino1Bullet(pygame.sprite.Sprite):

    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load('images/peluru/pelurudino1.png').convert_alpha()
    ...
    def update(self, enemy_bullets_group, player):
        ...
        if self.shots_fired < 20:
            ...
            if self.shoot_timer >= 100:
                ...
                dy = player.rect.centery - self.rect.centery
                direction = pygame.math.Vector2(dx, dy).normalize()
                bullet = Dino2Bullet(self.rect.centerx, self.rect.bottom, direction)
...
class Dino2Bullet(pygame.sprite.Sprite):

    def __init__(self, x, y, direction):
        super().__init__()
        self.image_orig = pygame.image.load('images/peluru/pelurudino2.png').convert_alpha()
    ...
    def update(self, enemy_bullets_group, player):
        ...
        if self.shots_fired < 20:
            ...
            if self.shoot_timer >= 120:
                ...
                dy = player.rect.centery - self.rect.centery
                direction = pygame.math.Vector2(dx, dy).normalize()
                bullet = Dino3Bullet(self.rect.centerx, self.rect.bottom, direction)
                enemy_bullets_group.add(bullet)
                self.shoot_timer = 0
                self.shots_fired += 1
        else:
...
class Dino3Bullet(pygame.sprite.Sprite):

    def __init__(self, x, y, direction):
        super().__init__()
        self.image_orig = pygame.image.load('images/peluru/pelurudino3.png').convert_alpha()
        self.image = self.image_orig
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.bottom = y + 10
